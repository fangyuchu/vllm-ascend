...
class NPUPlatform(Platform):
    ...
    def stateless_init_device_torch_dist_pg(
        ...
        **kwargs,
        ...
        """
        Initialize a stateless HCCL process group for Ascend devices.
        This method creates a ProcessGroup with the specified backend configuration,
        typically used for NPU communication. It sets up the necessary backend
        ...
        warning:
        Uses internal PyTorch API (torch_npu._C._distributed_c10d.ProcessGroupHCCL)
