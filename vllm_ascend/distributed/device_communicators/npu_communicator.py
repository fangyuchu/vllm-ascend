...
class _NpuAll2AllManager:
    ...
    # during scale_down. A per-step query_fault() could therefore never
    # observe anything; reporting False keeps the upstream runners from
    # paying for that query every step.
